...
-include vendor/one/config/BoardConfig.mk
...
_pdk_fusion_default_platform_zip = $(strip \
  ...
  $(wildcard vendor/pdk/$(TARGET_DEVICE)/$(patsubst one_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform/platform.zip) \
  $(wildcard vendor/pdk/$(TARGET_PRODUCT)/$(TARGET_PRODUCT)-$(TARGET_BUILD_VARIANT)/platform/platform.zip) \
  $(wildcard vendor/pdk/$(TARGET_PRODUCT)/$(patsubst one_%,full_%,$(TARGET_PRODUCT))-$(TARGET_BUILD_VARIANT)/platform/platform.zip))
...
-include $(TOPDIR)vendor/one/build/core/qcom_target.mk

# Rules for MTK targets
-include $(TOPDIR)vendor/one/build/core/mtk_target.mk
endif
